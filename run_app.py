#!/usr/bin/env python3
"""
Startup script for the Semantic Image Gallery application.
...
def run_application():
    ...
    print("\n🚀 Starting Semantic Image Gallery...")
...
def main():
    ...
    print("🖼️  Semantic Image Gallery - Startup Check")
    print("=" * 50)
    ...
    if not tesseract_available:
        print("\n⚠️  Tesseract not available - OCR features will be disabled")
